...
print
print ("\033[49m                   Welcome To BD Hacker Boys Virus                    \033[0m")
print ("\033[48m                   Author: KingNasirul                   \033[0m")
print
...
def help():
  print
  print ("\033[44m Developer : KingNasirul\033[0m")
  print ("\033[44m Program : BHBVirus\033[0m")
...
def main():
  ...
  if dr == "show options":
    ...
    ###########
		...
		android = raw_input(""+R+"BHB"+B+"Virus > ")
		if android == "run":
			time.sleep(1)
			...
			print
			print "Now check folder Virus on "+R+"/BHBVirus/virus/Antivirus/"+N+""
			print ""+B+"[*]"+N+"Finished"
			print
			main()
  elif dr == "01":
		rez = raw_input(""+R+"BHB"+B+"Virus > ")
		if rez == "run":
			time.sleep(1)
			print (""+G+"Freeze")
			...
			print
			print "Now check folder virus on"+R+" /BHBVirus/virus/freeze/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			print
			main()
  elif dr == "02":
		dea = raw_input(""+R+"BHB"+B+"Virus > ")
		if dea == "run":
			time.sleep(1)
			print (""+G+"Ransomware")
			print ""+B+"[*]"+N+" Downloading virus..."
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/BHBVirus/virus/androidran/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			print
			main()
  elif dr == "03":
		dea = raw_input(""+N+"BHBVirus > ")
		if dea == "run":
			time.sleep(1)
			print ""+B+"[*]"+N+" Downloading virus..."
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/BHBVirus/virus/malware/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			print
			main()
  elif dr == "04":
		dea = raw_input(""+N+"BHB"+B+"Virus > ")
		if dea == "run":
			time.sleep(1)
			print ""+B+"[*]"+N+" Downloading virus..."
			...
			time.sleep(1)
			print
			print "Now check foVIRvirus on "+R+"/BHBVirus/virus/Wannadecryptor/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/BHBVirus/virus/Wannadecryptor2/"
			time.sleep(1)
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/BHBVirus/virus/sms_tief/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			main()
  elif dr == "07":
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/BHBVirus/virus/dangerous-malware/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/BHBVirus/virus/malware_enc/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/BHBVirus/virus/malware_bnews/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			print
			main()
  elif dr == "BHBvirus update":
    print ""+G+"~ "+B+"UPDATING..."
    time.sleep(2)
    print ""+G+"Cloning repo..."
    time.sleep(6)
    os.system("cd ..;rm -rf VirusX;git clone https://github.com/KingNasirul/BHBVirus;cd BHBVirus;python2 BHB.py")
    main()
  elif dr == "10":
    time.sleep(1)
    print ""+R+"exiting..."
